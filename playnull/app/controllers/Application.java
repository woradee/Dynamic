...
public class Application extends Controller {
    ...
    public static Result main(Html content) {
        return main(main.render(content));
    }
    ...
    public static Result listTourist() {
        ...
        return ok(listTourist.render(touristList));
    }
    ...
    public static Result createTourist() {
        ...
        if (newForm.hasErrors()) {
            ...
            if (Tourist.finder.byId(tourist.getTid()) != null) {
                flash("errMessage", "รหัส Movie ซ้ำจ่ะ");
                return main(inputTourist.render(newForm, organizeList));
            } else {
...
/////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static Result seeTourist(String pid) {
        pictures = Pics.finder.byId(pid);
        if (pictures == null) {
            return listTourist2();
        } else {
            return main(seeTourist.render(picsList));
        }
    }
